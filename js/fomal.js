...
function createtime1() {
  var grt = new Date("04/02/2023 20:08:51"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Arol %c 你正在访问 Arol の 小窝!🧂",
...
const map = new Map();
map.set('oranges', "rgb(250,128,114)");
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("04/02/2023 20:08:51");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<span>什么时候能够实现财富自由呀</span><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<span>下班了就该开开心心地玩耍~</span><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("themeColor") == undefined) {
  localStorage.setItem("themeColor", "oranges");
}
...
//  小歪高清壁纸
let waiBizhi = "url(https://t.lizi.moe/pc)";
// 博天随机
...
let sj1 = "url(https://api.r10086.com/樱道随机图片api接口.php?自适应图片系列=缘之空)"
let ys = "url(https://api.r10086.com/樱道随机图片api接口.php?自适应图片系列=原神)"


// 背景
let default_bg = "http://www.98qy.com/sjbz/api.php";
let mobile_bg = "https://api.ghser.com/random/pe.php";
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(${default_bg});
    --darkmode-bg: url(${default_bg});
    --mobileday-bg: url(${mobile_bg});
    --mobilenight-bg: url(${mobile_bg});
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<h2>三、主题色设置</h2>
<div class="content" style="display:flex"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><input type="radio" id="oranges" name="colors" value=" "
        onclick="setColor('oranges')"><input type="radio" id="red" name="colors" value=" "
